...
QMIA_ARCHITECTURE=tabular-purchase-mlp-largedeep
...
--batch_size=32 --scheduler=step --scheduler_step_gamma=0.2 --scheduler_step_fraction=0.3 --lr=0.1 --weight_decay=5e-4 --epochs=50
